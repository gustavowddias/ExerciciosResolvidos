# **Todos os exercícios que já resolvi** 👨‍💻

### **Por que resolvi fazer exercícios?**
Eu entendi que a lógica de programação é mais importante que qualquer tecnologia ou framework que eu possa aprender. Não adianta conhecer tecnologia se eu não sou capaz de resolver problemas. O mercado precisa de 
programadores com uma base sólida e confiança para enfrentar uma montanha de erros vindos do terminal, sempre acreditando que são capazes de resolver cada problema, um de cada vez.
